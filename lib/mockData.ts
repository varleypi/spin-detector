...
export const OUTLETS: OutletScore[] = [
  ...
  { outletId: 'guardian', outletName: 'The Guardian', abbreviation: 'Guard', currentScore: 3.0, articleCount: 36, expectedRange: [2.5, 4.0] },
  { outletId: 'cnn', outletName: 'CNN', abbreviation: 'CNN', currentScore: 3.1, articleCount: 52, expectedRange: [2.5, 4.0] },
  { outletId: 'cbsnews', outletName: 'CBS News', abbreviation: 'CBS', currentScore: 3.5, articleCount: 43, expectedRange: [3.0, 4.5] },
  ...
  { outletId: 'economist', outletName: 'The Economist', abbreviation: 'Econ', currentScore: 5.0, articleCount: 22, expectedRange: [4.5, 6.0] },
  { outletId: 'cnbc', outletName: 'CNBC', abbreviation: 'CNBC', currentScore: 5.0, articleCount: 39, expectedRange: [4.5, 6.0] },
  { outletId: 'politico', outletName: 'Politico', abbreviation: 'PLTICO', currentScore: 5.1, articleCount: 71, expectedRange: [4.0, 5.5] },
  { outletId: 'newsweek', outletName: 'Newsweek', abbreviation: 'NW', currentScore: 5.2, articleCount: 31, expectedRange: [4.0, 5.5] },
  { outletId: 'forbes', outletName: 'Forbes', abbreviation: 'Forbes', currentScore: 5.8, articleCount: 28, expectedRange: [5.0, 6.5] },
  { outletId: 'wsj', outletName: 'Wall Street Journal', abbreviation: 'WSJ', currentScore: 6.3, articleCount: 57, expectedRange: [5.5, 7.0] },
...
export const OUTLET_TRENDS: Record<string, TrendPoint[]> = {
  ...
  guardian: generateTrend('guardian', 3.0, 0.5),
  cnn: generateTrend('cnn', 3.1, 0.5),
  cbsnews: generateTrend('cbsnews', 3.5, 0.4),
  ...
  economist: generateTrend('economist', 5.0, 0.3),
  cnbc: generateTrend('cnbc', 5.0, 0.4),
  politico: generateTrend('politico', 5.1, 0.6),
  newsweek: generateTrend('newsweek', 5.2, 0.5),
  forbes: generateTrend('forbes', 5.8, 0.5),
  wsj: generateTrend('wsj', 6.3, 0.4),
...
export const MOCK_STORIES: StoryCluster[] = [
  {
    ...
    articles: [
      ...
      {
        id: 'a7', outletId: 'guardian', outletName: 'The Guardian', clusterId: 'immigration-20260514',
      ...
      },
      {
        ...
        headline: 'Administration delivers on border promise as deportation numbers hit five-year high',
        url: 'https://washingtonexaminer.com', biasScore: 7.7, pubDate: '2026-05-14',
        biasSignals: ['"delivers on border promise" — validates administration framing', '"five-year high" presented as achievement', 'No acknowledgment of humanitarian concerns'],
      },
    ],
  },
  {
    ...
    articles: [
      ...
      {
        id: 'b6', outletId: 'cnbc', outletName: 'CNBC', clusterId: 'economy-20260514',
        headline: 'Fed holds rates steady; markets weigh timing of first cut as inflation cools gradually',
        url: 'https://cnbc.com', biasScore: 5.1, pubDate: '2026-05-14',
        biasSignals: ['Market-centric framing favors investor perspective', '"Cools gradually" — measured optimism', 'Neutral financial language throughout'],
      },
      {
        id: 'b7', outletId: 'wsj', outletName: 'Wall Street Journal', clusterId: 'economy-20260514',
        headline: 'Fed pauses as inflation data disappoints; rate cuts may be delayed into late year',
        url: 'https://wsj.com', biasScore: 6.1, pubDate: '2026-05-14',
        biasSignals: ['"Disappoints" frames data negatively relative to market expectations', '"May be delayed" — cautious pessimism', 'Business-class reader framing, less concern for wage workers'],
      },
    ],
  },
  {
    ...
    articles: [
      ...
      {
        id: 'c7', outletId: 'cbsnews', outletName: 'CBS News', clusterId: 'climate-20260514',
        headline: 'Scientists warn climate change risks accelerating as new report urges stronger policy action',
        url: 'https://cbsnews.com', biasScore: 3.4, pubDate: '2026-05-14',
        biasSignals: ['"Warn" and "urges" lean toward advocacy', 'Frames scientists as authoritative without counterpoint', '"Stronger policy action" implies current policy is insufficient'],
      },
      {
        id: 'c8', outletId: 'economist', outletName: 'The Economist', clusterId: 'climate-20260514',
        headline: 'The costs of inaction: new climate data underscores the economic case for carbon pricing',
        url: 'https://economist.com', biasScore: 5.3, pubDate: '2026-05-14',
        biasSignals: ['Market-mechanism framing is centrist', '"Economic case" grounds climate in fiscal logic', 'Slightly frames status quo as costly — marginal left lean on climate'],
      },
    ],
  },
  {
    ...
    articles: [
      ...
      {
        id: 'd6', outletId: 'newsweek', outletName: 'Newsweek', clusterId: 'guns-20260514',
        headline: 'Senate gun vote looms as polling shows majority support for universal background checks',
        url: 'https://newsweek.com', biasScore: 4.2, pubDate: '2026-05-14',
        biasSignals: ['Polling emphasis implies public mandate for legislation', 'Neutral procedural framing', '"Universal background checks" preferred framing over "gun control"'],
      },
      {
        id: 'd7', outletId: 'washexaminer', outletName: 'Washington Examiner', clusterId: 'guns-20260514',
        headline: 'Senate Dems push gun registry scheme disguised as background check expansion',
        url: 'https://washingtonexaminer.com', biasScore: 8.1, pubDate: '2026-05-14',
        biasSignals: ['"Registry scheme" — conspiracy framing', '"Disguised as" implies deliberate deception', 'Attributes sinister motive to legislative language'],
      },
    ],
  },
  {
    ...
    articles: [
      ...
      {
        id: 'e6', outletId: 'forbes', outletName: 'Forbes', clusterId: 'healthcare-20260514',
        headline: 'Medicare drug pricing deal: what investors need to know about pharma sector impact',
        url: 'https://forbes.com', biasScore: 6.0, pubDate: '2026-05-14',
        biasSignals: ['Investor-first framing centers shareholder interests', '"What investors need to know" — market perspective above patient outcomes', 'Neutral on policy but implicitly frames by financial impact'],
      },
      {
        id: 'e7', outletId: 'guardian', outletName: 'The Guardian', clusterId: 'healthcare-20260514',
        headline: 'Medicare price curbs offer lifeline to millions priced out of essential medications',
        url: 'https://theguardian.com', biasScore: 2.3, pubDate: '2026-05-14',
        biasSignals: ['"Lifeline" — emotionally charged benefit framing', '"Priced out" — victim framing for patients', 'No representation of pharmaceutical or market-side concerns'],
      },
    ],
  },
]
